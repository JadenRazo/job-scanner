...
const COUNTRY_PATTERNS: Array<[RegExp, string]> = [
  ...
  [/\b(mexico|mx-|mexico city|guadalajara|monterrey)\b/i, "MX"],
  [/\b(united kingdom|u\.?k\.?|england|scotland|wales|northern ireland|london|manchester|birmingham|edinburgh|glasgow|leeds|bristol|cambridge uk)\b/i, "UK"],
  [/\b(ireland|dublin|cork|galway)\b/i, "IE"],
  [/\b(germany|deutschland|berlin|munich|frankfurt|hamburg|cologne|stuttgart)\b/i, "DE"],
  [/\b(france|paris|lyon|marseille|toulouse|bordeaux|nice)\b/i, "FR"],
  [/\b(spain|madrid|barcelona|valencia|seville)\b/i, "ES"],
  [/\b(portugal|lisbon|porto)\b/i, "PT"],
  [/\b(italy|italia|rome|milan|milano|turin|naples|florence)\b/i, "IT"],
  [/\b(netherlands|amsterdam|rotterdam|holland|the hague|utrecht|eindhoven)\b/i, "NL"],
  [/\b(belgium|brussels|antwerp|ghent)\b/i, "BE"],
  [/\b(switzerland|zurich|geneva|basel|bern)\b/i, "CH"],
  [/\b(austria|vienna|wien|salzburg)\b/i, "AT"],
  [/\b(sweden|stockholm|gothenburg|malmö|malmo)\b/i, "SE"],
  [/\b(denmark|copenhagen|aarhus)\b/i, "DK"],
  [/\b(norway|oslo|bergen|trondheim)\b/i, "NO"],
  [/\b(finland|helsinki|tampere|espoo)\b/i, "FI"],
  [/\b(poland|warsaw|krakow|gdansk|wroclaw|poznan|lodz)\b/i, "PL"],
  [/\b(czech|prague|brno)\b/i, "CZ"],
  [/\b(hungary|budapest)\b/i, "HU"],
  [/\b(romania|bucharest|cluj)\b/i, "RO"],
  [/\b(bulgaria|sofia)\b/i, "BG"],
  [/\b(greece|athens|thessaloniki)\b/i, "GR"],
  [/\b(turkey|istanbul|ankara|izmir)\b/i, "TR"],
  [/\b(israel|tel aviv|jerusalem|haifa|herzliya)\b/i, "IL"],
  [/\b(uae|dubai|abu dhabi)\b/i, "AE"],
  [/\b(saudi|riyadh|jeddah)\b/i, "SA"],
  [/\b(india|bangalore|bengaluru|mumbai|hyderabad|pune|chennai|delhi|gurgaon|noida|gurugram|kolkata|ahmedabad)\b/i, "IN"],
  ...
  [/\b(japan|tokyo|osaka|kyoto|yokohama|nagoya)\b/i, "JP"],
  [/\b(korea|seoul|busan|south korea)\b/i, "KR"],
  [/\b(china|beijing|shanghai|shenzhen|guangzhou|chengdu|hangzhou|p\.?r\.?c\.?)\b/i, "CN"],
  [/\b(hong kong|hk)\b/i, "HK"],
  [/\b(taiwan|taipei|taichung|taoyuan)\b/i, "TW"],
  [/\b(australia|sydney|melbourne|brisbane|perth|canberra)\b/i, "AU"],
  [/\b(new zealand|auckland|wellington|christchurch)\b/i, "NZ"],
  [/\b(brazil|brasil|são paulo|sao paulo|rio de janeiro|brasília|brasilia|belo horizonte|porto alegre)\b/i, "BR"],
  [/\b(argentina|buenos aires|córdoba|cordoba|rosario)\b/i, "AR"],
  [/\b(colombia|bogotá|bogota|medellín|medellin|cali)\b/i, "CO"],
  [/\b(chile|santiago|valparaíso|valparaiso)\b/i, "CL"],
  [/\b(peru|lima)\b/i, "PE"],
  [/\b(south africa|cape town|johannesburg|pretoria|durban)\b/i, "ZA"],
  ...
  [/\b(russia|russian|moscow|st petersburg|saint petersburg)\b/i, "RU"],
];
